...
public class BlockEnv {
    ...
    public static void initTransaction(Wallet wallet){
        ...
        genesisTransaction.outputs.add(new TransactionOutput(genesisTransaction.reciepient, genesisTransaction.value, BlockEnv.genesisTransaction.transactionId)); //manually add the Transactions Output
